(function () {
    ...
    const gameContentHeader = makeElement(`header`, `header`, `
<button class="back">
...
<div class="game__lives">
  ...
  <img src="img/heart__full.svg" class="game__heart" alt="Life" width="31" height="27">
    ...
    const buttonBack = gameContentHeader.querySelector(`.back`);
  ...
  <li class="stats__result stats__result--unknown"></li>
    ...
    button.forEach((element) => {
        element.addEventListener(`click`, () => {
            showScreen(gameContentHeader, statsSection);
        });
    });

    const buttonBack$1 = gameContentHeader.querySelector(`.back`);
    ...
    radioButton.forEach((element) => {
        ...
        element.addEventListener(`click`, () => {
            console.log(element.checked);
                // if (element.checked) {
            showScreen(gameContentHeader, game3ContentSection);
                // }
        });
    });

    const buttonBack$2 = gameContentHeader.querySelector(`.back`);
  ...
  <li class="stats__result stats__result--unknown"></li>
    ...
    const compareChecked = () => {
        if (isRadioButtonLeftBox && isRadioButtonRightBox) {
            showScreen(gameContentHeader, game2ContentSection);
        }
    };

    const buttonBack$3 = gameContentHeader.querySelector(`.back`);
    buttonBack$3.addEventListener(`click`, () => {
        main.innerHTML = ``;
        main.appendChild(moduleContent);
    });
...
<section class="rules">
    ...
    rulesButton.addEventListener('click', () => {
        showScreen(gameContentHeader, gameContentSection);
    });

    const buttonBack$4 = gameContentHeader.querySelector(`.back`);
    buttonBack$4.addEventListener(`click`, () => {
        main.innerHTML = ``;
        main.appendChild(moduleContent);
    });
...
<button class="greeting__continue" type="button">
  ...
  <svg class="icon" width="64" height="64" viewBox="0 0 64 64" fill="#000000">
    ...
    greetingContinue.addEventListener('click', () => {
        showScreen(gameContentHeader, rulesSection);
    });

    const moduleContent$1 = makeElement('section', 'intro', `
<button class="intro__asterisk asterisk" type="button"><span class="visually-hidden">Продолжить</span>*</button>
<p class="intro__motto"><sup>*</sup> Это не фото. Это рисунок маслом нидерландского художника-фотореалиста Tjalf Sparnaay.</p>
`, `intro`);

    const asterisk = moduleContent$1.querySelector(`.intro__asterisk`);

    asterisk.addEventListener(`click`, () => showScreen(moduleContent));

    showScreen(moduleContent$1);
